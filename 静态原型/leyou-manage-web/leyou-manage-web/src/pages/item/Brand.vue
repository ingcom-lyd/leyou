    ...
    <v-dialog v-model="show" max-width="600" scrollable v-if="show">
      <v-card>
        ...
        <v-card-text class="px-5 py-2">
          <!-- 表单 -->
          <brand-form v-bind:oldBrand="brand" v-bind:isEdit="isEdit" @close="show = false" @reload="getDataFromApi"/>
      ...
      editBrand(item) {
        ...
        //   .then(resp => {
          .then(({data}) => {
            ...
            // this.brand.categories = JSON.stringify(data);
            // console.log(JSON.stringify(data));
            // console.log(this.brand.categories);
            // console.log(this.brand);
            // this.brand = JSON.stringify(this.brand);
          })
